...
export function VscodeIcon({ className, ...props }: SVGProps<SVGSVGElement>) {
  ...
  return (
    <svg fill="none" viewBox="0 0 100 100" className={className} aria-hidden {...props}>
      <mask
        id={`vscode-${id}-a`}
        width="100"
        height="100"
